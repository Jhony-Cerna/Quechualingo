...
public class ControladorTestPrincipiante2 implements ActionListener{
    
    TestPrincipiante2 form;
    
    public ControladorTestPrincipiante2(TestPrincipiante2 ventana) {
        form = ventana;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == form.btnContinuar) {
            ...
            if(form.txtPregunta1.getText().toUpperCase().trim().equals("MI PAPÁ")){
            puntos++;
            }else puntosperdidos++;
            if(form.txtPregunta2.getText().toUpperCase().trim().equals("SOL")){
            puntos++;
            }else puntosperdidos++;
            if(form.txtPregunta3.getText().toUpperCase().trim().equals("¿MAMÁ?")){
            puntos++;
            }else puntosperdidos++;
            if(form.txtPregunta4.getText().toUpperCase().trim().equals("LAGO")){
            puntos++;
            }else puntosperdidos++;
            if(form.txtPregunta5.getText().toUpperCase().trim().equals("PAPÁ")){
            puntos++;
            }else puntosperdidos++;
            if(form.txtPregunta6.getText().toUpperCase().trim().equals("MUNDO")){
            puntos++;
            }else puntosperdidos++;
