...
import Vista.Examen.TestIntermedio3;
...
public class ControladorTestIntermedio3 implements ActionListener{
    
    TestIntermedio3 form;
    
    public ControladorTestIntermedio3(TestIntermedio3 ventana) {
        form = ventana;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == form.btnContinuar) {
            ...
            if(form.txtPregunta1.getText().toUpperCase().trim().equals("RIKUYTA MUNAN")){
            puntos++;
            }else puntosperdidos++;
            if(form.txtPregunta2.getText().toUpperCase().trim().equals("QUIERO TOMAR CAFÉ")){
            puntos++;
            }else if(form.txtPregunta2.getText().toUpperCase().trim().equals("QUIERO BEBER CAFÉ")){
            puntos++;
            }else puntosperdidos++;
            if(form.txtPregunta3.getText().toUpperCase().trim().equals("RIYNAYMI")){
            puntos++;
            }else puntosperdidos++;
            if(form.txtPregunta4.getText().toUpperCase().trim().equals("TENGO QUE ESTUDIAR")){
            puntos++;
            }else puntosperdidos++;
            if(form.txtPregunta5.getText().toUpperCase().trim().equals("RIYTA MUNAN")){
            puntos++;
            }else puntosperdidos++;
            if(form.txtPregunta6.getText().toUpperCase().trim().equals("TENGO QUE IRME")){
            puntos++;
            }else puntosperdidos++;
