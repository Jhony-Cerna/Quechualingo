...
public class ControladorTestPrincipiante1 implements ActionListener{
    
    TestPrincipiante1 form;
    
    public ControladorTestPrincipiante1(TestPrincipiante1 ventana) {
        form = ventana;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == form.btnContinuar) {
            ...
            if(form.txtPregunta1.getText().toUpperCase().trim().equals("PUKA")){
            puntos++;
            }else puntosperdidos++;
            if(form.txtPregunta2.getText().toUpperCase().trim().equals("KUYCHIPACHAY")){
            puntos++;
            }else puntosperdidos++;
            if(form.txtPregunta3.getText().toUpperCase().trim().equals("QUMIR")){
            puntos++;
            }else puntosperdidos++;
            if(form.txtPregunta4.getText().toUpperCase().trim().equals("ALLQU")){
            puntos++;
            }else puntosperdidos++;
            if(form.txtPregunta5.getText().toUpperCase().trim().equals("KILLACHAY")){
            puntos++;
            }else puntosperdidos++;
            if(form.txtPregunta6.getText().toUpperCase().trim().equals("CHALLLWA")){
            puntos++;
            }else puntosperdidos++;
