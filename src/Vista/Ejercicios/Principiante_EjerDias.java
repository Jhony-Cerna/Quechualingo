 ...
 * @author Jhony
 */
public class Principiante_EjerDias extends javax.swing.JFrame {

    /**
     * Creates new form Seleccion_Nivel
     */
    public Principiante_EjerDias() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jpbProgreso, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 40, 340, 20));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Ejercicio_Dias.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Principiante_EjerDias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Principiante_EjerDias().setVisible(true);
            }
        });
    }
