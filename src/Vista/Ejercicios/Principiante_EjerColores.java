 ...
 * @author Jhony
 */
public class Principiante_EjerColores extends javax.swing.JFrame {

    /**
     * Creates new form Seleccion_Nivel
     */
    public Principiante_EjerColores() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnConfirmar, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 330, 180, 50));

        txtPregunta7.setBorder(null);
        jPanel1.add(txtPregunta7, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 340, 100, 30));

        txtPregunta1.setBorder(null);
        jPanel1.add(txtPregunta1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, 110, 30));

        txtPregunta2.setBorder(null);
        jPanel1.add(txtPregunta2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 160, 100, 30));

        txtPregunta3.setBorder(null);
        jPanel1.add(txtPregunta3, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 160, 110, 30));

        txtPregunta4.setBorder(null);
        jPanel1.add(txtPregunta4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 250, 110, 30));

        txtPregunta5.setBorder(null);
        jPanel1.add(txtPregunta5, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 250, 110, 30));

        txtPregunta6.setBorder(null);
        jPanel1.add(txtPregunta6, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 250, 110, 30));
        ...
        jPanel1.add(jpbProgreso, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 40, 340, 20));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Ejercicio_colores.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Principiante_EjerColores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Principiante_EjerColores().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTextField txtPregunta7;
