 ...
 * @author Jhony
 */
public class Intermedio_FormacionOraciones extends javax.swing.JFrame {

    /**
     * Creates new form Seleccion_Nivel
     */
    public Intermedio_FormacionOraciones() {
       initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtPregunta2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 166, 120, 20));

        txtPregunta4.setBorder(null);
        jPanel1.add(txtPregunta4, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 270, 110, -1));

        txtPregunta1.setBorder(null);
        jPanel1.add(txtPregunta1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 164, 120, -1));

        txtPregunta3.setBorder(null);
        jPanel1.add(txtPregunta3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 270, 110, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Ejer_FormacionOraciones.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Intermedio_FormacionOraciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Intermedio_FormacionOraciones().setVisible(true);
            }
        });
    }
