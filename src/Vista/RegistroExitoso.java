...
public class RegistroExitoso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnContinuar, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 480, 350, 80));

        btnTraducir.setToolTipText("");
        btnTraducir.setBorderPainted(false);
        btnTraducir.setContentAreaFilled(false);
        jPanel1.add(btnTraducir, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 470, 90, 80));

        lblESP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/UIRegistroExitosoESP.jpg"))); // NOI18N
        jPanel1.add(lblESP, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1040, 590));

        lblQuechua.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/UIRegistroExitosoQUECHUA.jpg"))); // NOI18N
        jPanel1.add(lblQuechua, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1040, 590));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroExitoso().setVisible(true);
            }
        });
    }
